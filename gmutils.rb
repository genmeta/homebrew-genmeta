class Gmutils < Formula
  ...
  on_arm do
    url "https://download.dhttp.net/homebrew/gmutils-0.7.0-aarch64-apple-darwin.tar.gz"
    sha256 "a85cf0d022ab7a748c8d0d4359a8ed9c6c4b134eae5bc3f9350a4cad85d1a03b"
  end

  on_intel do
    url "https://download.dhttp.net/homebrew/gmutils-0.7.0-x86_64-apple-darwin.tar.gz"
